...
export default function LeadModal({ isOpen, onClose, lead }) {
  ...
  return (
    ...
    //     </div>
    //     <div className="bg-gradient-to-r from-blue-50  to-blue-100 w-full rounded p-1 ">
    ...
    // </div>
    <div className="fixed inset-0 flex items-center justify-center text-xs bg-black bg-opacity-50 z-50">
  <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[80%] max-w-full">
    <div className="flex justify-between items-center mb-4">
      <div className="flex items-center">
        <EnvelopeIcon className="h-5 w-5 text-gray-500" />
        <p className="font-semibold pl-2 text-sm sm:text-base">Engage with {lead.name}</p>
      </div>
    ...
    <div className="shadow-md rounded flex items-center p-3 mb-4 flex-wrap gap-3">
      <img
        src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80"
        alt="Author"
      ...
      />
      <div>
        <p className="font-semibold text-sm sm:text-base">{lead.name}</p>
        <div className="text-xs sm:text-sm text-gray-500">
          <p>In COO, Northwind Traders</p>
        </div>
      </div>
    </div>

    <div className="flex flex-col md:flex-row justify-between bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-3 rounded gap-4">
      <div className="flex items-center">
        <SparklesIcon className="h-4 w-4 text-gradient" />
        <p className="text-sm sm:text-base text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 pl-2">
          Jane may be interested in upgrading espresso machines for her in-store coffee shops.
        </p>
      </div>
      <div className="flex gap-2 flex-wrap">
        <button className="bg-white flex items-center px-4 py-2 rounded shadow text-sm">
          <PencilIcon className="h-4 w-4 text-gray-500 mr-2" /> Edit
        </button>
        <button className="flex items-center bg-gradient-to-r from-blue-500 to-pink-500 px-4 py-2 rounded shadow text-white text-sm">
          <PaperAirplaneIcon className="h-4 w-4 text-white mr-2" /> Approve and send
        </button>
      </div>
    </div>

    <div className="flex gap-4 shadow pt-4 pl-4 pb-2 mt-5 flex-wrap">
      <p className="text-sm text-gray-500">Engage</p>
      <p className="text-sm text-gray-500">Research</p>
    </div>

    <div className="bg-gradient-to-r from-blue-50 to-blue-100 w-full rounded p-3">
      <div className="bg-white rounded-md p-4">
        <p className="text-indigo-500 text-sm mb-2">Why I picked this lead</p>
        <ul className="list-disc ml-5 text-xs sm:text-sm">
          <li>
            Jane is a <span className="font-semibold">key decision maker</span> and was browsing{' '}
            <span className="font-semibold">'espresso machines'</span> on First Coffee's website.
          </li>
          <li>
          ...
          <li>
            Northwind Traders currently see <span className="font-semibold">$200M</span> in revenue
            from their in-store coffee shops.
          </li>
        </ul>

        <div className="flex flex-wrap mt-5 gap-3 sm:justify-center md:justify-start lg:justify-start">
  ...
  <div className="flex bg-white shadow-md rounded-lg p-3 w-full sm:w-[48%] md:w-[32%] lg:w-[20%]">
    <WindowIcon className="h-10 w-10 text-blue-500 mr-2" />
    <div>
      <p className="text-sm sm:text-base">Intent</p>
      <p className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 font-extrabold text-xs sm:text-sm">
        High
      </p>
    </div>
    ...
    <div className="border-2 border-gray-500 rounded-lg p-4 mt-5 bg-white">
      <div className="flex justify-between mb-2 items-center">
        <h2 className="font-semibold text-sm sm:text-base">About Jane</h2>
        <ChevronDownIcon className="h-5 w-5 text-gray-500" />
      </div>
      <p className="text-gray-500 text-xs sm:text-sm">
        {lead.name}, the Chief Operating Officer of Northwind Traders, is a dynamic leader with a
        proven track record in optimizing operations and enhancing customer experiences. Under her
        guidance, Northwind Traders' in-store coffee shops have flourished, becoming a hallmark of
        quality and innovation. Jane's commitment to excellence makes her an ideal partner for
        First Coffee.
      </p>
    </div>
  </div>
